        ...
        <div className="col-12 col-md-6">
          <div className="contact-us__info">
            ...
            <div className="contact-method">
              <div className="contact-method__item"><i className="fa fa-map-marker-alt"></i>
                <p>5 South Main Street Los Angeles, ZZ-96110 USA</p>
              </div>
              <div className="contact-method__item"><i className="fa fa-mobile-alt"></i>
                <p>125-711-811   |   125-668-886</p>
              </div>
              <div className="contact-method__item"><i className="fa fa-headphones-alt"></i>
